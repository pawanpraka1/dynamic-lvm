# Release Process
lvm-localpv follows a on quaterly release cadence for minor version releases. The scope of the release is determined by contributor availability. The scope is published in the [Release Tracker Projects](https://github.com/orgs/openebs/projects/78).
...
lvm-localpv is released with container images and a respective helm chart as the only recommended way of installation. Even though the [lvm-operator](./deploy/lvm-operator.yaml) is also published, it is generated by templating the helm chart itself.
...
https://hub.docker.com/r/openebs/lvm-driver/tags
https://github.com/openebs/lvm-localpv/tree/gh-pages
